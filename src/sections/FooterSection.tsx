...
const FooterSection: React.FC = () => {
  ...
  return (
    <footer ref={container} aria-label="Footer Navigation & Social Links" className="bg-[#0A0A0A] text-white pt-12 md:pt-24 overflow-hidden relative z-30" style={{ borderTopLeftRadius: '40px', borderTopRightRadius: '40px', marginTop: '-40px' }}>
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 pb-12 md:pb-24 flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12">
        ...
        <div className="w-full md:w-1/2 flex flex-row justify-start md:justify-end gap-16 sm:gap-24 lg:gap-32 mt-4 md:mt-6">
          <FadeIn delay={0.3} className="flex flex-col gap-4 md:gap-5">
            <h3 className="text-xs font-bold uppercase tracking-[0.15em] mb-2 text-white">Social</h3>
            <nav aria-label="Social Media Links" className="flex flex-col gap-4 md:gap-5">
              {[
                { 
                  label: 'Instagram', 
                ...
                <a 
                  ...
                  aria-label={`Mahadev Patro on ${social.label}`} 
          ...
          <FadeIn delay={0.4} className="flex flex-col gap-4 md:gap-5">
            <h3 className="text-xs font-bold uppercase tracking-[0.15em] mb-2 text-white">Navigation</h3>
            <nav aria-label="Footer Quick Navigation" className="flex flex-col gap-4 md:gap-5">
              {[
